...
export default function LandingPage() {
  ...
  const pricing = [
    { name: 'Free', price: '$0', period: 'month', features: ['Basic budgeting', '5 accounts', 'Monthly reports'] },
    { name: 'Pro', price: '$9.99', period: 'month', features: ['Unlimited accounts', 'AI insights', 'Receipt scanning', 'Priority support'], popular: true },
    { name: 'Premium', price: '$19.99', period: 'month', features: ['Everything in Pro', 'Investment tracking', 'Tax reports', 'Family sharing'] },
  ];
  ...
  return (
    <LinearGradient colors={['#0F172A', '#1E1B4B', '#0F172A']} style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        {pricing.map((p, i) => <PricingCard key={i} {...p} onSelect={() => router.push('/(auth)/signup')} />)}
