  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Ionicons name="pie-chart-outline" size={60} color={Colors.secondary} />
        <Text style={styles.text}>Budgeting Tools Coming Soon</Text>
        <Text style={styles.subtext}>Set limits for categories and track your spending against them.</Text>
      </View>
    </View>
  );
}
