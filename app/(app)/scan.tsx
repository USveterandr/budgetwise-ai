...
export default function ScanScreen() {
    ...
    const takePicture = async () => {
        ...
        try {
            ...
            // Optimize image if needed (resize)
            // Ideally we'd resize here to < 1024x1024 for faster Gemini processing
            // skipping manipulate for now since quality 0.5 is decent
