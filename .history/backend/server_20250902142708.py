...
# Database connection
if USE_SQLITE:
    from sqlite_db import get_user_by_email as sqlite_get_user_by_email, create_user as sqlite_create_user, update_user_fields as sqlite_update_user_fields, set_last_login as sqlite_set_last_login, get_user_by_id as sqlite_get_user_by_id
elif USE_SUPABASE:
