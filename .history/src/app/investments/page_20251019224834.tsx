...
export default function InvestmentsPage() {
  const [investments, setInvestments] = useState([
    ...
    { id: 4, name: "Bitcoin", symbol: "BTC", shares: 0.5, purchasePrice: 40000.00, currentPrice: 42500.00, value: 21250.00, profitLoss: 1250.00, profitLossPercentage: 6.25 },
  ]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-1">${totalValue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className={`text-2xl font-bold mt-1 ${totalProfitLoss >= 0 ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <Card className="shadow">
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-sm font-medium text-gray-500">Profit/Loss Percentage</p>
                  <h3 className={`text-2xl font-bold mt-1 ${profitLossPercentage >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                    {profitLossPercentage >= 0 ? '+' : ''}{profitLossPercentage.toFixed(2)}%
                  </h3>
                </div>
                <div className={`p-3 rounded-full ${profitLossPercentage >= 0 ? 'bg-green-100' : 'bg-red-100'}`}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {investments.map((investment) => (
                    <tr key={investment.id}>
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm font-medium ${investment.profitLoss >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                        {investment.profitLoss >= 0 ? '+' : ''}${Math.abs(investment.profitLoss).toFixed(2)} ({investment.profitLoss >= 0 ? '+' : ''}{investment.profitLossPercentage.toFixed(2)}%)
                      </td>
