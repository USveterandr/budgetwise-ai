...
const SubscriptionManager = () => {
  const subscriptions = [
    { name: 'Netflix', price: 15.99, nextPayment: '2023-11-01', category: 'Entertainment' },
    { name: 'Spotify Premium', price: 9.99, nextPayment: '2023-11-05', category: 'Music' },
    { name: 'Adobe Creative Cloud', price: 52.99, nextPayment: '2023-11-10', category: 'Software' },
    { name: 'Gym Membership', price: 25.00, nextPayment: '2023-11-15', category: 'Health' },
  ];
        ...
        {subscriptions.map((sub, index) => (
          <div key={index} className="subscription-item">
            ...
            <div className="subscription-price-date">
              ...
              <span className="subscription-date">{sub.nextPayment}</span>
            </div>
          </div>
        ))}
      </div>
