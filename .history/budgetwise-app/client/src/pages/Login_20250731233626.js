...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    // Defensive check for browser extensions like MetaMask
    if (typeof window !== 'undefined' && window.ethereum && window.ethereum.isMetaMask) {
      // Optional: You could add specific logic here if you were integrating with MetaMask
      // For now, we just acknowledge its presence and proceed with standard login.
      // This can sometimes prevent errors if the extension is in a problematic state.
