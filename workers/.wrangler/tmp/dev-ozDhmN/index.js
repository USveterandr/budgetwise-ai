...
// .wrangler/tmp/bundle-LxtrlK/checked-fetch.js
    ...
    if (request.method === "POST" && url.pathname === "/api/auth/signup") {
      try {
        ...
        const stmt = env.DB.prepare(`
          ...
          VALUES (?, ?, ?, ?, ?)
        `);
        await stmt.bind(userId, email, password_hash, full_name, (/* @__PURE__ */ new Date()).toISOString()).run();
...
// .wrangler/tmp/bundle-LxtrlK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LxtrlK/middleware-loader.entry.ts
