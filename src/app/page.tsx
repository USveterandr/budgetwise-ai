  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 left-1/4 w-96 h-96 bg-purple-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-hypnotic-pulse"></div>
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-indigo-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-hypnotic-pulse animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-pink-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-hypnotic-pulse animation-delay-4000"></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-blue-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-10 animate-pulse-glow"></div>
        
        {/* Additional hypnotic elements */}
        <div className="absolute top-1/4 left-1/6 w-48 h-48 bg-cyan-500 rounded-full mix-blend-soft-light filter blur-2xl opacity-15 animate-pulse-glow animation-delay-1000"></div>
        <div className="absolute bottom-1/3 right-1/6 w-56 h-56 bg-violet-500 rounded-full mix-blend-soft-light filter blur-2xl opacity-15 animate-hypnotic-pulse animation-delay-3000"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-indigo-200 leading-tight">
            ...
            <span className="block text-purple-300">AI-Powered</span>
            <span className="block">Intelligence</span>
          </h1>
          
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
            Transform your financial journey with advanced AI that analyzes spending patterns, predicts future trends, and automatically optimizes your investments for maximum returns.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-gray-400">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-sm">Join 25,000+ active users</span>
            </div>
            <div className="flex items-center">
              <CurrencyDollarIcon className="h-5 w-5 text-green-400 mr-2" />
              <span className="text-sm">Average savings increase: 37%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 max-w-4xl mx-auto">
          ...
          <blockquote className="text-xl md:text-2xl text-gray-200 mb-8 italic">
            BudgetWise AI completely transformed how I manage my finances. The predictive insights helped me identify hidden spending patterns and save 47% more in just 6 months.
          </blockquote>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center mb-24">
        <div className="bg-gradient-to-r from-purple-900/50 to-indigo-900/50 backdrop-blur-sm rounded-3xl p-12 border border-purple-500/30">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to Multiply Your Wealth?</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            Join 25,000+ users who are already building lasting wealth with our AI-powered platform. Start your free trial today.
          </p>
