  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -top-1/3 left-1/4 w-96 h-96 bg-purple-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-30 animate-pulse-glow"></div>
        <div className="absolute top-1/4 right-1/3 w-80 h-80 bg-indigo-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-25 animate-hypnotic-pulse animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-pink-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-hypnotic-pulse animation-delay-4000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500 rounded-full mix-blend-soft-light filter blur-3xl opacity-15 animate-pulse"></div>
        
        {/* Additional hypnotic elements */}
        <div className="absolute top-1/5 left-1/6 w-48 h-48 bg-cyan-500 rounded-full mix-blend-soft-light filter blur-2xl opacity-20 animate-pulse-glow animation-delay-1000"></div>
        <div className="absolute bottom-1/3 right-1/5 w-56 h-56 bg-violet-500 rounded-full mix-blend-soft-light filter blur-2xl opacity-15 animate-hypnotic-pulse animation-delay-3000"></div>
        
        {/* Floating particles for extra hypnotic effect */}
        <div className="absolute top-1/4 left-1/5 w-4 h-4 bg-white rounded-full opacity-10 animate-float animation-delay-1000"></div>
        <div className="absolute top-2/3 right-1/4 w-3 h-3 bg-purple-300 rounded-full opacity-15 animate-float animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-2/3 w-2 h-2 bg-pink-300 rounded-full opacity-20 animate-float animation-delay-3500"></div>
        
        {/* New hypnotic wave effect */}
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-purple-500/5 to-transparent animate-wave"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-red-500 to-orange-500 rounded-full border border-red-400/30 mb-6 animate-pulse">
            <FireIcon className="h-5 w-5 text-white mr-2" />
            <span className="text-sm font-bold text-white">LIMITED TIME: 50% OFF ANNUAL PLANS</span>
            <FireIcon className="h-5 w-5 text-white ml-2" />
          </div>
          
          {/* Urgency Timer */}
          <div className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-full border border-purple-500/30 mb-6">
            <ClockIcon className="h-5 w-5 text-purple-300 mr-2" />
          ...
          <div className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-full border border-purple-500/30 mb-8 animate-pulse">
            <SparklesIcon className="h-5 w-5 text-purple-300 mr-2" />
            <span className="text-sm font-medium text-purple-200">#1 AI-Powered Finance App</span>
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-indigo-200 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Button className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-8 py-4 text-lg font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-xl animate-pulse-glow">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-gray-300 mb-8">
            <div className="flex items-center">
              ...
              <span className="ml-3 font-bold">50,000+ Active Users</span>
            </div>
            <div className="flex items-center">
              <CurrencyDollarIcon className="h-5 w-5 text-green-400 mr-2" />
              <span className="font-bold">Average Savings: 42%</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
            ...
            <span className="flex items-center">
              <AcademicCapIcon className="h-4 w-4 text-blue-400 mr-1" />
            ...
            <span className="flex items-center">
              <BoltIcon className="h-4 w-4 text-yellow-400 mr-1" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-white/5 backdrop-blur-sm rounded-3xl mx-4 mb-24 border border-white/10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why BudgetWise is a Must-Have App</h2>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="text-left">
              ...
              <div className="text-gray-400">Investment Manager, San Francisco</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center mb-24">
        <div className="bg-gradient-to-r from-purple-900/60 to-indigo-900/60 backdrop-blur-sm rounded-3xl p-12 border border-purple-500/40 shadow-2xl">
          <div className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-red-500 to-orange-500 rounded-full border border-red-400/30 mb-6 animate-pulse">
            <FireIcon className="h-5 w-5 text-white mr-2" />
            <span className="text-sm font-bold text-white">FINAL HOURS: 50% OFF ENDS SOON!</span>
          </div>
          
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Don&apos;t Miss Out on Financial Freedom</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-8">
            <Button className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-12 py-6 text-2xl font-bold rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 animate-pulse">
              <Link href="/auth/signup" className="w-full h-full flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-300">Risk-free for 7 days</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-gray-300 mb-8">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm">✓ Join 50,000+ users</span>
            </div>
            <div className="flex items-center">
          ...
          <div className="mt-8 p-4 bg-black/20 rounded-xl inline-block">
            <div className="text-gray-300 mb-2">Limited time offer ends in:</div>
